...
def _overlay_defaults(kwargs):
    if "scalacopts" not in kwargs:
        kwargs["scalacopts"] = _default_scalacopts
...
def scala_binary(**kwargs):
    return upstream_scala_binary(**_overlay_defaults(kwargs))

def scala_library(**kwargs):
    return upstream_scala_library(**_overlay_defaults(kwargs))

def scala_test(**kwargs):
    return upstream_scala_test(**_overlay_defaults(kwargs))
